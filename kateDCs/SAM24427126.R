...
cites =  abs$name[8:16]
# Read data
data = Read10X(data.dir = "SAM24427126_CellRanger/")
...
# Add experiment info
seu@meta.data$Experiment = "WholeTumor"
...
# 
seu@meta.data$hash.ID = factor(seu@meta.data$hash.ID) 
HashIDPalette = c("firebrick","firebrick","forestgreen","forestgreen","navy","navy","yellow")
...
SaveH5Seurat(seu, filename = "SAM24427126.h5Seurat")
Convert("SAM24427126.h5Seurat", dest = "h5ad")
saveRDS(seu,"SAM24427126.rds")
