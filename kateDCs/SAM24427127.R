...
cites =  abs$name[8:16]
# Read data
data = Read10X(data.dir = "SAM24427127_CellRanger/")
...
SaveH5Seurat(seu, filename = "SAM24427127.h5Seurat")
Convert("SAM24427127.h5Seurat", dest = "h5ad")
saveRDS(seu,"SAM24427127.rds")
