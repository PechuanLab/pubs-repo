...
setwd("/gstore/scratch/u/pechuanj/NGS2180_Brain/BrainJasmine/LIB5420512_HITS5440155/outs")
# read data
cell_bender_mat = Read_CellBender_h5_Mat("HITS5440155_filtered.h5",)
...
# Add Metadata
seu@meta.data$PatientID = "CT2"
seu@meta.data$HITS = "LIB5420512_HITS5440155"
seu@meta.data$Tissue = "rCH"
seu@meta.data$Diagnosis = "Control"
seu@meta.data$Operator = "JC"
seu@meta.data$SampleName = "S05-0188"
seu@meta.data$Triad = "T217"
name = "LIB5420512_HITS5440155"
...
VlnPlot(seu,"ROBO1")
saveRDS(seu,"Seurat_HITS5440155.rds")
