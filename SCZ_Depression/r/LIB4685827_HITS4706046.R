...
setwd("/gstore/scratch/u/pechuanj/NGS2180_Brain/BrainJasmine/LIB4685827_HITS4706046/outs")
# read data
cell_bender_mat = Read_CellBender_h5_Mat("HITS4706046_filtered.h5",)
...
seu@meta.data$HITS = "LIB4685827_HITS4706046"
...
VlnPlot(seu,"CADPS2")
saveRDS(seu,"Seurat_HITS4706046.rds")
