...
setwd("/gstore/scratch/u/pechuanj/NGS2180_Brain/BrainJasmine/LIB4685828_HITS4706047/outs")
# read data
cell_bender_mat = Read_CellBender_h5_Mat("HITS4706047_filtered.h5",)
...
seu@meta.data$HITS = "LIB4685828_HITS4706047"
...
VlnPlot(seu,"CADPS2")
saveRDS(seu,"Seurat_HITS4706047.rds")
