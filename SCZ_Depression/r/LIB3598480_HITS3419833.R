...
setwd("~/Downloads/")
# read data
cell_bender_mat = Read_CellBender_h5_Mat("~/Downloads/LIB3598480_HITS3419833_filtered.h5",)
...
seu@meta.data$HITS = "LIB3598480_HITS3419833"
seu@meta.data$Tissue = "rSMG"
seu@meta.data$Diagnosis = "SCZ"
seu@meta.data$Operator = "JC"
seu@meta.data$SampleName = "S10-0290"
seu@meta.data$Triad = "T216"
seu@meta.data$DetailedID = "SCZ_rSMG_1"
name = "LIB3598480_HITS3419833"
...
saveRDS(seu,"Seurat_LIB3598480_HITS3419833.rds")
