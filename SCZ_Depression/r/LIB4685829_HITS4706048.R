...
setwd("~/Downloads/")
# read data
cell_bender_mat = Read_CellBender_h5_Mat("~/Downloads/LIB4685829_HITS4706048_filtered.h5",)
...
seu@meta.data$HITS = "LIB4685829_HITS4706048"
...
saveRDS(seu,"Seurat_LIB4685829_HITS4706048.rds")
