...
setwd("~/Downloads/")
# read data
cell_bender_mat = Read_CellBender_h5_Mat("~/Downloads/LIB3691195_HITS3419839_filtered.h5",)
...
seu@meta.data$HITS = "LIB3691195_HITS3419839"
...
seu@meta.data$DetailedID = "SCZ_rCH_1"
name = "LIB3691195_HITS3419839"
...
saveRDS(seu,"Seurat_LIB3691195_HITS3419839.rds")
