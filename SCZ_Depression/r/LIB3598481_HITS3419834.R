...
setwd("~/Downloads/")
# read data
cell_bender_mat = Read_CellBender_h5_Mat("~/Downloads/LIB3598481_HITS3419834_filtered.h5",)
...
# Add Metadata
seu@meta.data$PatientID = "DEP1"
seu@meta.data$HITS = "LIB3598481_HITS3419834"
seu@meta.data$Tissue = "rSMG"
seu@meta.data$Diagnosis = "DEP"
seu@meta.data$Operator = "JC"
seu@meta.data$SampleName = "S98-0049"
seu@meta.data$Triad = "T216"
seu@meta.data$DetailedID = "DEP_rSMG_1"
name = "LIB3598481_HITS3419834"
...
saveRDS(seu,"Seurat_LIB3598481_HITS3419834.rds")
