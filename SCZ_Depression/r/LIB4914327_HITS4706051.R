...
setwd("/gstore/scratch/u/pechuanj/NGS2180_Brain/BrainJasmine/LIB4914327_HITS4706051/outs")
# read data
cell_bender_mat = Read_CellBender_h5_Mat("HITS4706051_filtered.h5",)
...
# Add Metadata
seu@meta.data$PatientID = "DEP2"
seu@meta.data$HITS = "LIB4914327_HITS4706051"
seu@meta.data$Tissue = "rCH"
seu@meta.data$Diagnosis = "Depression"
seu@meta.data$Operator = "JC"
seu@meta.data$SampleName = "S10-0040"
seu@meta.data$Triad = "T217"
name = "LIB4914327_HITS4706051"
...
VlnPlot(seu,"CADPS2")
saveRDS(seu,"Seurat_HITS4706051.rds")
