...
setwd("~/Downloads/")
# read data
cell_bender_mat = Read_CellBender_h5_Mat("~/Downloads/LIB5420514_HITS5440156_filtered.h5",)
...
# Add Metadata
seu@meta.data$PatientID = "CT3"
seu@meta.data$HITS = "LIB5420514_HITS5440156"
seu@meta.data$Tissue = "rCH"
seu@meta.data$Diagnosis = "CT"
seu@meta.data$Operator = "JC"
seu@meta.data$SampleName = "S05-0198"
seu@meta.data$Triad = "T219"
seu@meta.data$DetailedID = "CT_rCH_3"
name = "LIB5420514_HITS5440156"
...
saveRDS(seu,"Seurat_LIB5420514_HITS5440156.rds")
