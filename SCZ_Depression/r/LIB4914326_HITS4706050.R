...
setwd("/gstore/scratch/u/pechuanj/NGS2180_Brain/BrainJasmine/LIB4914326_HITS4706050/outs")
# read data
cell_bender_mat = Read_CellBender_h5_Mat("HITS4706050_filtered.h5",)
...
# Add Metadata
seu@meta.data$PatientID = "SCZ2"
seu@meta.data$HITS = "LIB4914326_HITS4706050"
seu@meta.data$Tissue = "rCH"
seu@meta.data$Diagnosis = "Schizophrenia"
seu@meta.data$Operator = "JC"
seu@meta.data$SampleName = "S99-0060"
seu@meta.data$Triad = "T217"
name = "LIB4914326_HITS4706050"
...
VlnPlot(seu,"CADPS2")
saveRDS(seu,"Seurat_HITS4706050.rds")
