...
setwd("/gstore/scratch/u/pechuanj/NGS2180_Brain/BrainJasmine/LIB3438490_HITS3419823/outs")
# read data
cell_bender_mat = Read_CellBender_h5_Mat("HITS3419823.h5",)
...
# Add Metadata
seu@meta.data$PatientID = "Ct1"
seu@meta.data$HITS = "LIB3438490_HITS3419823"
seu@meta.data$Tissue = "rSMG"
seu@meta.data$Diagnosis = "Control"
seu@meta.data$Operator = "HI"
seu@meta.data$SampleName = "S03-0124"
...
pdf("IGrubmanLabels_umap.pdf",width = 12, height = 12)
...
FeaturePlot(seu,"MOBP")
saveRDS(seu,"Seurat_HITS3419823.rds")
