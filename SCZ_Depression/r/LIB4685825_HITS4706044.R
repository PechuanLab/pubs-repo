...
setwd("/gstore/scratch/u/pechuanj/NGS2180_Brain/BrainJasmine/LIB4685825_HITS4706044/outs")
# read data
cell_bender_mat = Read_CellBender_h5_Mat("HITS4706044_filtered.h5",)
...
seu@meta.data$HITS = "LIB4685825_HITS4706044"
...
VlnPlot(seu,"CADPS2")
saveRDS(seu,"Seurat_HITS4706044.rds")
