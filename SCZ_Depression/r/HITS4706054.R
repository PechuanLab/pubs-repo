...
setwd("/gstore/scratch/u/pechuanj/NGS2180_Brain/BrainJasmine/LIB4914330_HITS4706054/outs")
# read data
cell_bender_mat = Read_CellBender_h5_Mat("HITS4706054_filtered.h5",)
...
seu@meta.data$HITS = "LIB4914330_HITS4706054"
...
VlnPlot(seu,"CADPS2")
saveRDS(seu,"Seurat_HITS4706054.rds")
